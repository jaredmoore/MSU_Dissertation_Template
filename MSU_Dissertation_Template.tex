...
\include{c3-some_content}
\include{c4-some_content}
\include{c5-how_much_content_do_you_have}
\include{c6-still_going_huh}
\include{c7-okay_you_should_consider_wrapping_it_up}
\include{c8-might_want_to_buy_your_committee_wine_when_they_read_this}
\include{c9-conclusions_and_future_work}
...
%\end{centering}
%\newpage
%\input{appendix} %====Put you Appendix text here
%\clearpage
...
\bibliography{library} %your bib file here
\end{singlespace}
\end{doublespace}
\end{document}
